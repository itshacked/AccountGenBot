...
async def hmm(event):
    if Config.JTU_ENABLE:
    	...
    	if starky is False:
        	await event.reply("**🤣CHANNEL JOIN KAR PHIR START KAR DUBARA🤣**", buttons=[[custom.Button.url("Join Channel", Config.CHANNEL_URL)]])
        	return
...
Bot Made With ❤️ By @ARYA_ASSISTANCEBOT For @Netflix_Premium_Trick**
""" 
...
/about - To Get Your Current Info[How many accounts left today to gen]
